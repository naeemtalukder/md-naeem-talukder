    ...
    return (
        <div id='hero' className='flex flex-col md:flex-row items-center justify-center gap-10 md:gap-20 py-12'>
            <div className="w-full md:w-6/12 text-center">
                ...
                <a href="https://drive.google.com/u/0/uc?id=1zXsGInrH9wINzsBnipfVF9EiIB1cTRIE&export=download" className='inline-block px-8 py-3 my-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-500 hover:bg-indigo-700 md:text-md'>Download Resume</a>
            </div>
            <img
